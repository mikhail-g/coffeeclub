...
```json
{
  "roaster": {
    ...
    "buy_in_person": "<true/false>",
    "decaf_available": "<true/false>",
    "roast_style": ["<values known so far>"],
    "roast_date_provided": "<true/false or null if unknown>",
    "sca_score_provided": "<true/false or null if unknown>",
    "notes": "<notes or null>",
    "last_synced": null,
